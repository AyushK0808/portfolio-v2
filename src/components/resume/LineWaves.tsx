...
// Line-waves background — ported from ReactBits (reactbits.dev/backgrounds/line-waves),
// tinted to the site's cyan/teal/violet flight-deck palette. Renders full-bleed
// animated warped scanlines on a single fragment-shader triangle via ogl.
