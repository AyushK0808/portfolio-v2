...
// Aurora background — ported from ReactBits (reactbits.dev/backgrounds/aurora),
// tinted to the site's cyan/teal/violet flight-deck palette. Renders a
// full-bleed animated aurora on a single fragment-shader triangle via ogl.
...
export default function Aurora({
  colorStops = ['#00D9F5', '#B266FF', '#2FE0C8'],
  amplitude = 1.0,
  blend = 0.5,
  speed = 0.7,
}: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      program!.uniforms.uTime.value = t * 0.01 * (p.speed ?? 0.7) * 0.1;
